...
{
    public class tbl_patient_checknum_file_info_Dal
    {
        public tbl_patient_checknum_file_info_Dal()
		{}
		#region  成员方法
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("insert into tbl_patient_checknum_file_info(");
            strSql.Append("uuid,check_uuid,checkmode,createtime,path )");
